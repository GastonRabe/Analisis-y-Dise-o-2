...
public class PanelReceptor extends JFrame implements IVista {
	...
	private JRadioButton rdbtnAsistenciaMedica_1;
...
*/
	...
	public PanelReceptor() {
		...
		this.rdbtnAsistenciaMedica_1 = new JRadioButton("Asistencia Medica");
		this.rdbtnAsistenciaMedica_1.setBounds(34, 0, 237, 30);
		this.panel_2.add(this.rdbtnAsistenciaMedica_1);
		
		this.rdbtnNewRadioButton = new JRadioButton("Personal de seguridad");
		this.rdbtnNewRadioButton.setBounds(34, 29, 237, 30);
		this.panel_2.add(this.rdbtnNewRadioButton);
		
		this.rdbtnNewRadioButton_3 = new JRadioButton("Foco de incendio");
		this.rdbtnNewRadioButton_3.setBounds(34, 60, 237, 30);
		this.panel_2.add(this.rdbtnNewRadioButton_3);
